...
namespace GameServer.Game
{
    ...
    public class HostedGame
    {
        ...
        private WebSocketCollection<GameWebSocketService> clients;
        private PushFrenzy.Rules.Game game;
        ...
        private void StartGame()
        {
            ...
            Started = true;
            gameTimer = new Timer(o => ProcessCommand(new TimerTickCommand()), null, 0, PushFrenzy.Rules.Game.ExpectedTickIntervalMilliseconds);
        }        
    ...
    {
        public GameWebSocketService Client { get; private set; }
